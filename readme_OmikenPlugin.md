...
![](Pasted image 20250124113616.png)

### 🎯1-1.自動返信してくれる BOT で、わんコメの配信をもっと楽しく

おみくじ BOT プラグイン OmikenPlugin は、わんコメのプラグインとして動作する、多機能な拡張機能です。BOT を通じて配信者とリスナーの双方向のやり取りを促進し、より魅力的な配信作りをサポートします。

このプラグインの開発に 1 年を費やし、単純なおみくじから 1000 通り以上のバリエーションを持つおみくじを簡単に作成できる機能を実現しました。

これまでにない賑やかな配信をお求めなら、おみくじ BOT プラグイン をお試しください！

### ✨ 1-2.できること

![](Pasted image 20250124113319.png)
...
![](Pasted image 20250124112222.png)
...
![](Pasted image 20250124111355.png)
...
![[Pasted image 20250124111610.png]]
...
![](Pasted image 20250124112612.png)
...
![](Pasted image 20250124112855.png)
