...
import { PluginUpdateData, StoreMainType, VisitType } from '@type';
...
export class CommentBotProcessor {
 ...
 // 初期化
 constructor(private storeAll: StoreMainType, private comment: Comment, private userData: UserNameData) {
